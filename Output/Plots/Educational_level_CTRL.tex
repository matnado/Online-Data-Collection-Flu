...
\draw[draw=none,fill=color0] (axis cs:-0.4,0) rectangle (axis cs:0.4,13);
\draw[draw=none,fill=color1] (axis cs:0.6,0) rectangle (axis cs:1.4,21);
\draw[draw=none,fill=color2] (axis cs:1.6,0) rectangle (axis cs:2.4,5);
\draw[draw=none,fill=color3] (axis cs:2.6,0) rectangle (axis cs:3.4,1);
